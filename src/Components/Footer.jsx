      ...
      <div className="max-w-[1216px]   px-6 py-12 mx-auto">
        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 ">
          <div className=' md:mr-4 mb-4 md:mb-0'>
            <h3 className="text-[16px] font-bold mb-4 text-white">
              Hire Talent
            </h3>
            <hr />
            <div className="flex text-[14px] flex-col items-start mt-4 space-y-4">
              {[
                ...
                <a
                  key={item}
                  href="#"
                  className="text-gray-200 transition-colors duration-200 hover:underline hover:text-blue-600"
                >
                  {item}
                </a>
              ))}
          ...
          <div>
            ...
            <hr />
            <div className="flex text-[16px] flex-col items-start mt-4 space-y-4">
              {[
                'Software Developers',
                'Web Developers',
          ...
          <div>
            <h3 className="text-[14px] font-bold md:mt-10 text-white">
